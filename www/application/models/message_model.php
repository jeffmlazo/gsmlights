...
class Message_model extends CI_Model {
    ...
    public function getMessages()
    {
         ...
         */
        $this->db->select("message.*, account.phone_number, account.username AS account_username, LOWER(DATE_FORMAT(log.created_on, '%m/%d/%Y %h:%i %p')) AS created_on", FALSE);
        $this->db->join('log', 'log.message_id = message.id', 'left');
