...
class Job_title extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->load->view('contents/job_titles/create');
    }
    ...
    public function save()
    {
        ...
        $this->form_validation->set_rules($config['save_job_title_validation']);
        ...
        if ($this->form_validation->run())
        {
            ...
            $entity_id = $this->job_title_model->save($arr_data);
            // Check if inserted data was successful
            if ($entity_id)
            {
                $log_data = array(
                    'job_title_id' => $entity_id,
                ...
                $json_msg = array('status' => 'success', 'msg' => sprintf($this->lang->line('success_form_add'), 'job title'));
            }
            else
            {
    ...
    // TODO: reconstruct this function for job title list
